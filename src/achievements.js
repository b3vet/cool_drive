...
export const ACHIEVEMENTS = [
  ...
  { id: 'close_call', icon: '🧷', name: 'Close Call', desc: 'Shave past 25 obstacles mid-drift', test: (s) => s.nearMisses >= 25 },
  { id: 'linked_up', icon: '🔗', name: 'Linked Up', desc: 'Chain 4 direction changes in one drift', test: (s) => s.bestLinks >= 4 },
  { id: 'ring_runner', icon: '💫', name: 'Ring Runner', desc: 'Complete a ring run on a wild circuit', test: (s) => s.ringRuns >= 1 },
  { id: 'pathfinder', icon: '📍', name: 'Pathfinder', desc: 'Discover 8 regions', test: (s) => s.regionsSeen >= 8 },
